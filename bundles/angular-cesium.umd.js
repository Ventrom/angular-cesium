    ...
    ***************************************************************************** */
    ...
    var EntitiesDrawerService = /** @class */ (function (_super) {
        ...
        function EntitiesDrawerService(cesiumService, graphicsType, defaultOptions) {
            ...
            _this.graphicsTypeName = exports.ɵf[_this.graphicsType];
            // Fix bad enum compilation
            for (var i in exports.ɵf) {
                if (exports.ɵf[i] === _this.graphicsType) {
    ...
    var MapEventsManagerService = /** @class */ (function () {
        ...
        MapEventsManagerService.prototype.createEventRegistration = function (_a) {
            ...
            if (!CesiumDragDropHelper.dragEvents.has(event)) {
                observable = cesiumEventObservable.pipe(operators.filter(function () { return !registration.isPaused; }), operators.map(function (movement) { return _this.triggerPick(movement, pickOption, pickConfig); }), operators.filter(function (result) { return result.cesiumEntities !== null || entityType === undefined; }), operators.map(function (picksAndMovement) { return _this.addEntities(picksAndMovement, entityType, pickOption, pickFilter); }), operators.filter(function (result) { return result.entities !== null || (entityType === undefined && !pickFilter); }), operators.switchMap(function (entitiesAndMovement) { return _this.plonter(entitiesAndMovement, pickOption); }), operators.takeUntil(stopper));
            }
            else {
                ...
                }).pipe(operators.takeUntil(stopper));
            }
        ...
        MapEventsManagerService.prototype.createDragEvent = function (_a) {
            ...
            var dragObserver = mouseDownRegistration.observable.pipe(operators.mergeMap(function (e) {
                ...
                return mouseMoveObservable.pipe(operators.map(function (movement) {
                    ...
                    return lastMove;
                }), operators.takeUntil(mouseUpObservable), operators.tap({
                    complete: function () {
                        // On complete
                        if (lastMove) {
    ...
    })(exports.MapTerrainProviderOptions || (exports.MapTerrainProviderOptions = {}));
    ...
    var AcMapTerrainProviderComponent = /** @class */ (function () {
        ...
        AcMapTerrainProviderComponent.prototype.ngOnInit = function () {
            if (!Checker.present(this.options.url)
                && this.provider !== exports.MapTerrainProviderOptions.Ellipsoid
                && this.provider !== exports.MapTerrainProviderOptions.WorldTerrain) {
                throw new Error('options must have a url');
            }
            this.defaultTerrainProvider = this.cesiumService.getViewer().terrainProvider;
            switch (this.provider) {
                case exports.MapTerrainProviderOptions.CesiumTerrain:
                case exports.MapTerrainProviderOptions.ArcGISTiledElevation:
                case exports.MapTerrainProviderOptions.GoogleEarthEnterprise:
                case exports.MapTerrainProviderOptions.VRTheWorld:
                case exports.MapTerrainProviderOptions.Ellipsoid:
                    this.terrainProvider = new this.provider(this.options);
                    break;
                case exports.MapTerrainProviderOptions.WorldTerrain:
    ...
    var DEFAULT_POINT_OPTIONS = {
        addLastPointEvent: exports.CesiumEvent.LEFT_CLICK,
    ...
    var PointsEditorComponent = /** @class */ (function () {
        function PointsEditorComponent(pointsEditor, coordinateConverter, mapEventsManager, cameraService, pointsManager, cesiumService) {
            ...
            this.cesiumService = cesiumService;
            this.Cesium = Cesium;
            this.editPoint$ = new rxjs.Subject();
            this.pointLabels$ = new rxjs.Subject();
    ...
    var DEFAULT_ELLIPSE_OPTIONS = {
        ...
        dragPointEvent: exports.CesiumEvent.LEFT_CLICK_DRAG,
        dragShapeEvent: exports.CesiumEvent.LEFT_CLICK_DRAG,
        circleToEllipseTransformEvent: exports.CesiumEvent.LEFT_CLICK,
        circleToEllipseTransformEventModifier: exports.CesiumEventModifier.ALT,
        allowDrag: true,
        ellipseProps: {
            material: Cesium.Color.CORNFLOWERBLUE.withAlpha(0.4),
            fill: true,
        ...
        EllipsesEditorService.prototype.editEllipse = function (id, priority, editSubject, options, editObservable) {
            ...
            pointDragRegistration
                ...
                if (!options.allowDrag && _this.ellipsesManager.get(id).enableEdit &&
                    (editAction === exports.EditActions.DRAG_SHAPE || editAction === exports.EditActions.DRAG_SHAPE_FINISH)) {
                    _this.cameraService.enableInputs(true);
                    return;
                }
    ...
    var EllipsesEditorComponent = /** @class */ (function () {
        ...
        EllipsesEditorComponent.prototype.handleEditUpdates = function (update) {
            switch (update.editAction) {
                ...
                case exports.EditActions.TRANSFORM: {
                    var ellipse = this.ellipsesManager.get(update.id);
                    if (ellipse && ellipse.enableEdit) {
    ...
    var AcToolbarComponent = /** @class */ (function () {
        ...
        AcToolbarComponent.prototype.listenForDragging = function () {
            ...
            this.mouseMove$ = this.mouseMove$ || rxjs.fromEvent(document, 'mousemove');
            this.mouseUp$ = this.mouseUp$ || rxjs.fromEvent(document, 'mouseup');
            this.drag$ = this.drag$ ||
        ...
        RangeAndBearingComponent.prototype.create = function (_a) {
            ...
            if (labelsRenderFn) {
                ...
                rnb.setLabelsRenderFn(function (update) {
                    ...
                    return (update.editMode === exports.EditModes.CREATE && update.editAction !== exports.EditActions.ADD_LAST_POINT
    ...
    var ZoomToRectangleService = /** @class */ (function () {
        function ZoomToRectangleService(mapsManager, cameraService, cesiumService) {
            ...
            this.defaultOptions = {
                ...
                threshold: 9,
                keepRotation: true,
                mouseButton: exports.MouseButtons.LEFT,
            };
        }
    ...
    var RectanglesEditorComponent = /** @class */ (function () {
        function RectanglesEditorComponent(rectanglesEditor, coordinateConverter, mapEventsManager, cameraService, rectanglesManager, cesiumService) {
            ...
            this.Cesium = Cesium;
            this.editPoints$ = new rxjs.Subject();
            this.editRectangles$ = new rxjs.Subject();
    ...
    exports.AcCzmlDescComponent = AcCzmlDescComponent;
    ...
    exports.AcMapTerrainProviderComponent = AcMapTerrainProviderComponent;
    exports.AcModelDescComponent = AcModelDescComponent;
    ...
    exports.AcPointPrimitiveDescComponent = AcPointPrimitiveDescComponent;
    ...
    exports.AcRectangleComponent = AcRectangleComponent;
    ...
    exports.EditableRectangle = EditableRectangle;
    ...
    exports.PointEditorObservable = PointEditorObservable;
    exports.PointsEditorComponent = PointsEditorComponent;
    exports.PointsEditorService = PointsEditorService;
    ...
    exports.RectangleEditorObservable = RectangleEditorObservable;
    exports.RectanglesEditorComponent = RectanglesEditorComponent;
    exports.RectanglesEditorService = RectanglesEditorService;
    ...
    exports.ɵbs = AcContextMenuWrapperComponent;
    exports.ɵbt = AcHtmlManager;
    exports.ɵbu = AcHtmlContext;
    exports.ɵbv = AcHtmlDirective;
    exports.ɵbw = AcHtmlContainerDirective;
    exports.ɵbx = BasicStaticPrimitiveDesc;
    exports.ɵby = PointsManagerService;
    exports.ɵbz = HippodromeManagerService;
    exports.ɵc = BillboardDrawerService;
    exports.ɵca = PolygonsManagerService;
    exports.ɵcb = RectanglesManagerService;
    exports.ɵcc = CirclesManagerService;
    exports.ɵcd = EllipsesManagerService;
    exports.ɵce = PolylinesManagerService;
    exports.ɵcf = DragIconComponent;
