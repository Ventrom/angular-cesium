    ...
    var CesiumPureEventObserver = /** @class */ (function () {
         ...
         */
            function (eventsHandler) {
                var _this = this;
                this.observer = rxjs.Observable.create(( /**
                 * @param {?} observer
                 * @return {?}
                 */function (observer) {
    ...
    var CesiumLongPressObserver = /** @class */ (function (_super) {
         ...
         */
            function () {
                ...
                /** @type {?} */
                var longPressObservable = operators.publish()(startEventObservable.pipe(operators.mergeMap(( /**
                 * @param {?} e
                 * @return {?}
                 */function (e) { return rxjs.of(e).pipe(operators.delay(CesiumLongPressObserver.LONG_PRESS_EVENTS_DURATION), operators.takeUntil(stopEventObservable)); }))));
    ...
    var MapEventsManagerService = /** @class */ (function () {
         ...
         */
            function (event, modifier, entityType, pickOption, priority, pickFilter) {
                ...
                if (!CesiumDragDropHelper.dragEvents.has(event)) {
                    observable = cesiumEventObservable.pipe(operators.filter(( /**
                     * @return {?}
                     */function () { return !registration.isPaused; })), operators.map(( /**
                     * @param {?} movement
                     * @return {?}
                     */function (movement) { return _this.triggerPick(movement, pickOption); })), operators.filter(( /**
                     * @param {?} result
                     * @return {?}
                     */function (result) { return result.cesiumEntities !== null || entityType === undefined; })), operators.map(( /**
                     * @param {?} picksAndMovement
                     * @return {?}
                     */function (picksAndMovement) { return _this.addEntities(picksAndMovement, entityType, pickOption, pickFilter); })), operators.filter(( /**
                     * @param {?} result
                     * @return {?}
                     */function (result) { return result.entities !== null || (entityType === undefined && !pickFilter); })), operators.switchMap(( /**
                     * @param {?} entitiesAndMovement
                     * @return {?}
                     */function (entitiesAndMovement) { return _this.plonter(entitiesAndMovement, pickOption); })), operators.takeUntil(stopper));
                }
                else {
         ...
         */
            function (event, modifier, entityType, pickOption, priority, pickFilter) {
                ...
                /** @type {?} */
                var dragObserver = mouseDownRegistration.observable.pipe(operators.mergeMap(( /**
                 * @param {?} e
                 * @return {?}
                 */function (e) {
                    /** @type {?} */
                    ...
                    return mouseMoveObservable.pipe(operators.map(( /**
                     * @param {?} movement
                     * @return {?}
                     */function (movement) {
                        lastMove = {
                        ...
                        return lastMove;
                    })), operators.takeUntil(mouseUpObservable), operators.tap(undefined, undefined, ( /**
                     * @return {?}
                     */function () {
                        // On complete
                        if (lastMove) {
    ...
    var AcLayerComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                rxjs.merge(this._updateStream, this.observable).pipe(operators.takeUntil(this.stopObservable)).subscribe(( /**
                 * @param {?} notification
                 * @return {?}
         ...
         */
            function (collection) {
                ...
                rxjs.from(collection).subscribe(( /**
                 * @param {?} entity
                 * @return {?}
    ...
    var CesiumProperties = /** @class */ (function () {
         ...
         */
            function (expression, withCache) {
                 ...
                 * @param {?} prop
                 * @return {?}
                 */function (resultExpression, prop) {
    ...
    var AcBillboardDescComponent = /** @class */ (function (_super) {
        ...
        AcBillboardDescComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: '',
                        providers: [{ provide: BasicDesc, useExisting: core.forwardRef(( /**
                                         * @return {?}
    ...
    var SelectionManagerService = /** @class */ (function () {
         ...
         */
            function (selectionOptions, addSelectedIndicator, eventPriority, mapId) {
                ...
                eventSubscription.pipe(operators.map(( /**
                 * @param {?} result
                 * @return {?}
                 */function (result) { return result.entities; })), operators.filter(( /**
                 * @param {?} entities
                 * @return {?}
    ...
    var PolygonsEditorService = /** @class */ (function () {
         ...
         */
            function (id, positions, priority, editSubject, options, editObservable) {
                ...
                pointDragRegistration.pipe(operators.tap(( /**
                 * @param {?} __0
                 * @return {?}
                 */function (_a) {
    ...
    var DraggableToMapService = /** @class */ (function () {
         ...
         */
            function () {
                ...
                var lastMove;
                /** @type {?} */
                var moveObservable = pointerMove.pipe(operators.map(( /**
                 * @param {?} e
                 * @return {?}
                 */function (e) {
                    ...
                    return lastMove;
                })), operators.takeUntil(pointerUp), operators.tap(undefined, undefined, ( /**
                 * @return {?}
                 */function () {
                    if (lastMove) {
                        /** @type {?} */
    ...
    var AcToolbarComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                if (this.allowDrag) {
                    /** @type {?} */
                    var mouseDown$ = rxjs.fromEvent(this.element.nativeElement, 'mousedown');
                    /** @type {?} */
                    var mouseMove$_1 = rxjs.fromEvent(document, 'mousemove');
                    /** @type {?} */
                    var mouseUp$_1 = rxjs.fromEvent(document, 'mouseup');
                    /** @type {?} */
                    var drag$ = mouseDown$.pipe(operators.switchMap(( /**
                     * @return {?}
                     */function () { return mouseMove$_1.pipe(operators.takeUntil(mouseUp$_1)); })));
