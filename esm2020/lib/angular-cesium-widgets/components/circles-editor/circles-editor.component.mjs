...
CirclesEditorComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.12", ngImport: i0, type: CirclesEditorComponent, deps: [{ token: i1.CirclesEditorService }, { token: i2.CoordinateConverter }, { token: i3.MapEventsManagerService }, { token: i4.CameraService }, { token: i5.CirclesManagerService }], target: i0.ɵɵFactoryTarget.Component });
