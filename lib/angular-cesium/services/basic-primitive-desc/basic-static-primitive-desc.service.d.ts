...
export declare class BasicStaticPrimitiveDesc extends BasicDesc implements OnInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<BasicStaticPrimitiveDesc, never, never, { "geometryProps": { "alias": "geometryProps"; "required": false; }; "instanceProps": { "alias": "instanceProps"; "required": false; }; "primitiveProps": { "alias": "primitiveProps"; "required": false; }; }, {}, never, never, false, never>;
}
