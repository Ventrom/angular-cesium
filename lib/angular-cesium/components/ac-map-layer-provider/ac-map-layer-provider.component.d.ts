...
export declare class AcMapLayerProviderComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AcMapLayerProviderComponent, "ac-map-layer-provider", never, { "options": "options"; "provider": "provider"; "index": "index"; "show": "show"; "alpha": "alpha"; "brightness": "brightness"; "contrast": "contrast"; }, {}, never, never, false>;
}
