...
export declare class AcLayerComponent implements OnInit, OnChanges, AfterContentInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AcLayerComponent, "ac-layer", never, { "show": "show"; "acFor": "acFor"; "context": "context"; "store": "store"; "options": "options"; "zIndex": "zIndex"; "debug": "debug"; }, {}, never, ["*"], false>;
}
