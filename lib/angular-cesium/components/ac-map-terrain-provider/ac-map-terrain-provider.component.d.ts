...
export declare class AcMapTerrainProviderComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AcMapTerrainProviderComponent, "ac-map-terrain-provider", never, { "options": "options"; "provider": "provider"; "show": "show"; }, {}, never, never, false>;
}
