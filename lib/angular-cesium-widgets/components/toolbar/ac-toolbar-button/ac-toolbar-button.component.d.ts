...
export declare class AcToolbarButtonComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AcToolbarButtonComponent, "ac-toolbar-button", never, { "iconUrl": "iconUrl"; "buttonClass": "buttonClass"; "iconClass": "iconClass"; }, { "onClick": "onClick"; }, never, ["*"], false>;
}
