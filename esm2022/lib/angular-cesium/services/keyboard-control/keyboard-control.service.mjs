...
export class KeyboardControlService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.1.2", ngImport: i0, type: KeyboardControlService, deps: [{ token: i0.NgZone }, { token: i1.CesiumService }, { token: DOCUMENT }], target: i0.ɵɵFactoryTarget.Injectable }); }
